...
3. Add `fototeca` to the `ckan.plugins` setting in your CKAN
...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.fototeca.some_setting = some_default_value
...
## Releasing a new version of ckanext-fototeca

If ckanext-fototeca should be available on PyPI you can follow these steps to publish a new version:
